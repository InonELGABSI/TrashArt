...
export const HomePage = () => {
    const aboutText = (
        <>
            היא קהילה יצירתית שמוכיחה שמה שנזרק יכול להפוך ליצירת אמנות.
            <br />
            כאן נפגשים אמנים, מעצבים, ויוצרים מכל תחום
            <br />
            כדי להעניק חיים חדשים לחומרים ישנים.
            <br />
            אנחנו מאמינים שמהפכה סביבתית מתחילה ביצירתיות, ובאמנות שמחברת בין אדם לסביבה.
            <br />
            <br />
            <br />
            באתר שלנו תמצאו השראה, מדריכים, ותוכן שיפתח לכם את הראש
            <br />
            וגם מערכת <span className="font-alumni tracking-wide text-3xl">AI</span> חכמה שתעזור לכם לגלות רעיונות חדשים, להפוך סקיצה ליצירה,
            <br />
