            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
                    {items.map((item, index) => (
                        ...
                        >
                            <div className="w-64 h-64 bg-[#EDE8DE] rounded-[2.5rem] overflow-hidden shadow-lg flex flex-col items-center justify-center gap-4">
                                <img 
                                    src={item.img} 
                                    alt={item.title} 
                                    className="w-24 h-24 object-contain"
                                />
                                <h3 className="text-[36px] font-bold text-[#1A1A2E] text-center">
                                    {item.title}
                                </h3>
                            </div>
                        </div>
