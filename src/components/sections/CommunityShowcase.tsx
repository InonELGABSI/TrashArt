...
הקהילה שלנו יוצרת שינוי
          ...
          <p className=" text-[24px] leading-relaxed mb-8">
שתפו גם את היצירה שלכם והצטרפו לעשייה
          </p>
          <button className=" text-[24px] bg-[var(--color-dark-blue)] text-white px-8 py-3 rounded-lg font-semibold cursor-pointer">
            שתפו יצירה
          </button>
        </div>
        <div className="w-full lg:w-1/2">
          <VerticalCar images={carouselImages} speed={22} height="750px" />
        </div>
      </div>
    </section>
  );
